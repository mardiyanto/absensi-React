...
export default function Page() {
  ...
  const API_URL = 'http://192.168.168.9/crudreact-native/api.php';
  ...
  const simpanData = () => {
    ...
    let url = `${API_URL}?op=create`;
    let method = 'POST';

    if (editId) {
      url = `${API_URL}?op=update&id=${editId}`;
    }
